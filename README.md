...
1. Checkout this project repo and confirm the path is in Docker's file sharing config - https://docs.docker.com/docker-for-mac/#file-sharing
    ...
    ```bash
    git clone https://github.com/lagoon-examples/demo-polysite-drupal.git demo-polysite-drupal && cd $_
    ```
...
4. Visit the new site @ `http://demo-polysite-drupal.docker.amazee.io`
...
6. Visit the new site @ `http://demo-polysite-drupal.lndo.site`
